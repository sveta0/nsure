...
export class Contract extends ethereum.SmartContract {
  ...
  addMinter(_addMinter: Address): boolean {
    let result = super.call("addMinter", "addMinter(address):(bool)", [
      ethereum.Value.fromAddress(_addMinter)
    ]);

    return result[0].toBoolean();
  }

  try_addMinter(_addMinter: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("addMinter", "addMinter(address):(bool)", [
      ethereum.Value.fromAddress(_addMinter)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  delMinter(_delMinter: Address): boolean {
    let result = super.call("delMinter", "delMinter(address):(bool)", [
      ethereum.Value.fromAddress(_delMinter)
    ]);

    return result[0].toBoolean();
  }

  try_delMinter(_delMinter: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall("delMinter", "delMinter(address):(bool)", [
      ethereum.Value.fromAddress(_delMinter)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getMinterLength(): BigInt {
    let result = super.call(
      "getMinterLength",
      "getMinterLength():(uint256)",
      []
    );
  ...
  try_getMinterLength(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getMinterLength",
      "getMinterLength():(uint256)",
      []
...
export class DelMinterCall extends ethereum.Call {
  get inputs(): DelMinterCall__Inputs {
    return new DelMinterCall__Inputs(this);
  }

  get outputs(): DelMinterCall__Outputs {
    return new DelMinterCall__Outputs(this);
  }
}

export class DelMinterCall__Inputs {
  _call: DelMinterCall;

  constructor(call: DelMinterCall) {
    this._call = call;
  }

  get _delMinter(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class DelMinterCall__Outputs {
  _call: DelMinterCall;
